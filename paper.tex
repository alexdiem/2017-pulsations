...
The numerical model of the MCA was run over four heartbeats to ensure convergence of the results. A human heartbeat lasts \SI{0.85}{\second} and the total simulation time was \SI{3.4}{\second}
